            ...
            <form class="layui-form" action="/email/maxSend?flag=5"  method="post" id="form1">
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        ...
                        <button class="layui-btn"  lay-filter="demo2"  ><i class="layui-icon">&#xe60e;</i> 定时发送</button>
                        <button class="layui-btn"  lay-filter="demo3" onclick="Drafts()"><i class="layui-icon">&#xe655;</i> 存草稿</button>
...
//        alert(1);
        ...
        form1.setAttribute('action','/email/send?flag=3');
